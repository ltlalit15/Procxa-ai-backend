...
const sequelize = new Sequelize(
  ...
  {
    host: DB_HOST,
    port: DB_PORT,          // ✅ REQUIRED for Railway
    dialect: 'mysql',
    logging: false,
  }
);

// ✅ Proper async connection test
(async () => {
  try {
    await sequelize.authenticate();
    console.log("✅ Database connected successfully (Railway MySQL)");
  } catch (error) {
...
// ⚠️ Railway pe first time ke liye alter:false hi rakho
